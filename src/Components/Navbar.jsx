...
<div className={` h-20 mb-2  bg-black px-2 lg:px-0 flex items-center justify-between sticky top-0 left-10 z-50 mx-auto`}>
      <div className="logo ">
        <Link to="/" title="Arif Basha" className=" text-2xl font-poppins text-[#F34629] cursor-default tracking-wider text-nowrap md:mr-16 mr-0 " >Arif Basha</Link >
      </div>
      ...
      <div className={`btn flex lg:hidden gap-2 lg:static absolute ${nav}  text-sm font-medium gap-10 -z-10 pt-20 pb-10 lg:py-0 h-fit  lg:translate-0 flex-col justify-end items-center  w-full bg-[#000000bd] lg:flex-row top-14 left-0 bg-blaack z-index-[1]  transition-all duration-500 ease-in-out border-b-2 border-[#F34629]`}>
      ...
      <div className="search pl-3 py-1 flex gap-2 justify-between lg:hidden items-center  ">
        ...
        <button onClick={toggleMenu} className={`menu lg:hidden p-1.5 flex cursor-pointer items-center rounded-full outline-none  `}>
