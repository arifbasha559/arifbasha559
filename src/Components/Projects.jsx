...
const Projects = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5 w-full overflow-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-10 lg:gap-5 px-5 md:px-10 lg:px-20 my-5 lg:items-start min-h-[calc(100vh-90px)] w-full">
        {data.map((item, index) => (
          <>
            <div
              key={index}
              className="group hidden relative w-full aspect-[16/9]  bg-black rounded-xl lg:flex items-center justify-center overflow-hidden perspective-1000 shadow-[0_0_5px_rgba(255,255,255,0.5)] transition-all duration-600 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] hover:shadow-[0_8px_16px_rgba(255,255,255,0.2)]"
            >
              {/* SVG Icon */}
