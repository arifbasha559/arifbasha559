...
const Services = () => {
  ...
  return (
    <div className="min-h-[80vh] mt-auto flex flex-col justify-center items-center"  data-aos="fade-up" >
      ...
      {/* Cards section */}
      <div className="flex flex-col w-full lg:w-3/4 mx-auto  text-gray-300 justify-center items-center">
