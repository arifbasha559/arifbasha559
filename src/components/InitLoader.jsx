...
export default function InitLoader({ onFinish }) {
    ...
    return (
        <div
            className={`fixed cursor-wait h-screen w-screen z-50 bg-black flex items-center justify-center transition-transform duration-700 ${slideUp ? "-translate-y-full pointer-events-none" : "translate-y-0"
                }`}
        >
            <div className="flex items-center justify-center h-screen w-screen ">
                ...
                <div className="w-32 h-32 relative flex items-center justify-center">
                    ...
                    <div className="w-full h-full relative flex items-center justify-center">
                        <div
                            className="absolute inset-0 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 animate-[spin_1s_ease-in-out_infinite] blur-sm"
                        ></div>
